...
Serializable {
	...
	public void mouseDragged(MouseEvent e) {
		if (e.getButton() == 1) mouse1State = true;
		if (e.getButton() == 2) mouse2State = true;
	...
	public void mouseReleased(MouseEvent e) {
		e.translatePoint(viewx, viewy);
		lastMousePos = e;
		if (e.getButton() == 1) mouse1State = false;
		if (e.getButton() == 2) mouse2State = false;
	...
	public synchronized void shiftCamera(int deltax, int deltay) {
		...
		if (lastMousePos != null)lastMousePos.translatePoint(deltax, deltay);
